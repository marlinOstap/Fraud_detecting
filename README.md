...
**RU:**
Проект посвящён обнаружению мошеннических транзакций по банковским картам с использованием методов машинного обучения.
Цель — выявление редких мошеннических операций в сильно несбалансированных данных.
---
